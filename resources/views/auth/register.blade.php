...
<head>
    ...
    <style>
        ...
        * { font-family: 'Inter', sans-serif; }
        ...
        .orb-1 { width: 300px; height: 300px; background: var(--accent-violet); top: -100px; left: -50px; animation: orbMove1 12s ease-in-out infinite; }
        .orb-2 { width: 250px; height: 250px; background: var(--accent-cyan); bottom: -80px; right: -60px; animation: orbMove2 15s ease-in-out infinite; }
        .orb-3 { width: 200px; height: 200px; background: var(--accent-emerald); top: 40%; right: 20%; animation: orbMove1 18s ease-in-out infinite reverse; }
        .input-field {
            background: rgba(255, 255, 255, 0.05);
            border: 1px solid rgba(255, 255, 255, 0.1);
        ...
        .input-field:focus { border-color: var(--accent-violet); box-shadow: 0 0 0 3px rgba(139, 92, 246, 0.15); outline: none; }
...
<body class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="register-card rounded-3xl p-8 w-full max-w-md relative z-10">
        <div class="text-center mb-8">
            ...
            <p class="text-white/40 text-sm">Join Water Refill Management</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="mb-4">
                <label class="block text-white/60 text-sm font-medium mb-2">Full Name</label>
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{ old('email') }}" required
                    class="input-field w-full px-4 py-3 rounded-xl text-sm" placeholder="you@example.com">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-6">
                <label class="block text-white/60 text-sm font-medium mb-2">Confirm Password</label>
        ...
        <div class="text-center mt-6">
            <p class="text-white/30 text-sm">
                Already have an account? <a href="/login" class="text-cyan-400 hover:text-cyan-300 transition-colors font-medium">Sign in</a>
            </p>
        </div>
    </div>
</body>
