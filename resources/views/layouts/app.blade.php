@php
    ...
    elseif (request()->routeIs('admin.menus')) $activePage = 'menus';
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse x-cloak class="mt-1 space-y-0.5">
                        ...
                        <a href="/vehicles" class="nav-link {{ $activePage === 'vehicles' ? 'active' : '' }}" @click="sidebarOpen = false" style="padding-left: 2.5rem;">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17a2 2 0 100-4 2 2 0 000 4zm8 0a2 2 0 100-4 2 2 0 000 4zM5 17H3V8l2-3h12l3 5v7h-2.5"/></svg>
                            Vehicles
                        </a>
